...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        "--pretrained_model_name_or_path_dm",
        type=str,
        default=None,
        required=True,
    ...
    parser.add_argument(
        "--pretrained_model_name_or_path_llm",
        type=str,
        default=None,
        required=True,
        help="Path to pretrained model or model identifier from transformers.",
    )
    parser.add_argument(
...
if __name__ == "__main__":
    ...
    available_tasks = ['distill_llm', 'validate_teacher']
    assert args.current_task in available_tasks

    if args.current_task == 'distill_llm':
        train(args)
